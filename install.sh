...
DOMAIN="${DOMAIN:-00.247.108.000}"
PORT="${PORT:-3013}"
UUID="${UUID:-2584b733-0000-4bec-a7d5-22b473540f7a}"
HY2_PASSWORD="${HY2_PASSWORD:-iytdi63ufi3hu}"

curl -sSL -o app.js https://raw.githubusercontent.com/NPV16/one-node/refs/heads/main/lunes-host/app.js
curl -sSL -o package.json https://raw.githubusercontent.com/NPV16/one-node/refs/heads/main/lunes-host/package.json
...
mv xray xy
curl -sSL -o config.json https://raw.githubusercontent.com/NPV16/one-node/refs/heads/main/lunes-host/xray-config.json
...
vlessUrl="vless://$UUID@$DOMAIN:$PORT?encryption=none&flow=xtls-rprx-vision&security=reality&sni=whatsapp.com&fp=chrome&pbk=$publicKey&sid=$shortId&spx=%2F&type=tcp&headerType=none#lunes-reality"
...
curl -sSL -o config.yaml https://raw.githubusercontent.com/NPV16/one-node/refs/heads/main/lunes-host/hysteria-config.yaml
